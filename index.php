...
<div id="sb-site" style="min-height: 599px;">
    ...
    <section id="main-slider" class="flexslider fullscreen" style="height: 599px;">      	
        ...
        <ul class="slides">
            ...
            <li style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1;" class="">
                <!-- SLIDE IMAGE -->
                <div data-stellar-ratio="0.5" class="slide-image" style="top: 0px; display: block; background-image: url('wedding_files/slides/5.jpg');">
                </div>
            ...
            <li style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1;" class="">
                <!-- SLIDE IMAGE -->
                <div data-stellar-ratio="0.5" class="slide-image" style="top: 0px; display: block; background-image: url('wedding_files/slides/6.jpg');">
                </div>
            ...
            <li style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1;" class="">
                <!-- SLIDE IMAGE -->
                <div data-stellar-ratio="0.5" class="slide-image" style="top: 0px; display: block; background-image: url('wedding_files/slides/4.jpg');">
                </div>
